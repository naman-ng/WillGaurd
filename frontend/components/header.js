        ...
        <nav class="bg-fblack border-gray-200 py-2.5 dark:bg-gray-900">
          <div class="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
            ...
            <div class="flex items-center lg:order-2">
              <a
                class="text-gray-800 cursor-pointer dark:text-white hover:bg-purple-600 hover:text-white focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 sm:mr-2 dark:hover:bg-white focus:outline-none dark:focus:ring-gray-800"
              >
              </a>
