...
const legacyAddModal = () => {
  ...
  return (
    <>
      <button
        className="text-2xl font-semibold bg-purple-600 text-white py-3 px-16 self-start mx-5 mt-12 border-none rounded-full"
        onClick={show}
      >
        Add new beneficiary
      </button>
        ...
        <div className="fixed top-0 left-0 bottom-0 right-0 bg-black/[0.5] flex justify-center text-center z-1">
          <div className="bg-white pt-2 pb-8 px-10 rounded-3xl h-fit text-black self-center">
            ...
            <div className="mb-2 flex flex-col">
              ...
              >
                <option value="ERC20">5ire Token</option>
                <option value="ERC721">5ire NFTs</option>
                <option value="ERC1155">5ire ERC1155</option>
              </select>
            </div>
            <div className="mb-2 flex flex-col">
              <label
