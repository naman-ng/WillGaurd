...
',Arial,sans-serif"><rect x="0" y="0" width="100%" height="100%" fill="#eee" rx="10%" /><g id="text" fill="black" font-size="80" font-weight="500" text-anchor="middle"><text x="50%" y="40%" font-weight="700">WILLGAURD</text><text x="50%" y="65%">LEGACY</text><text x="90%" y="90%" font-size="36" text-anchor="end">';
